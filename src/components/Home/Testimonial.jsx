        ...
        <section className="mb-5">
            <div className="   ">
                <div className="w-full  flex flex-wrap">
                    <div className="w-1/4 max-sm:w-full max-sm:pt-0 max-sm:text-center pt-12 px-3 ">
                        <h2 className="text-3xl break-words font-bold tracking-tight text-[#000] sm:text-4xl">
                            Player Feedback
                        </h2>
                    ...
                    <div className=" mt-8  w-3/4  max-sm:w-full" >
                        ...
                        <div className='px-3'>
                            ...
                            >
                                ...
                                {data.data.ratings.map((item, index) => (
                                    <blockquote key={index} className="rounded-lg bg-gray-50 block shadow-sm p-2  overflow-hidden">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="mt-0.5 text-lg font-medium text-gray-900">{item.userName}</p>
                                            </div>
                                        </div>
                                        <p className="my-4 text-gray-700 text-xs break-words">{item.messages}</p>
                                    </blockquote>
                                ))}
